function [bgProb, bdCon, bgWeight,geoDistMatrix] = EstimateBgProb(colDistM, adjcMatrix, bdIds, clipVal, geoSigma)
...
[bdCon,geoDistMatrix] = BoundaryConnectivity(adjcMatrix, colDistM, bdIds, clipVal, geoSigma, true);
